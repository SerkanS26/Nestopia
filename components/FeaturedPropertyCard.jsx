  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl shadow-md relative flex flex-col md:flex-row">
        <Image
          src={
            property.images.length > 0 ? property.images[1] : property.images[0]
          }
          alt=""
          width={0}
          height={0}
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            ...
            <Link
              ...
              className="h-[36px] bg-secondary hover:bg-primary text-white px-4 py-2 ml-2 rounded-lg text-center text-sm"
            >
              Details
            </Link>
          </div>
