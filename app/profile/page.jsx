    ...
    <section className="bg-softGreen">
      <div className="container m-auto py-20">
        <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
          <h1 className="text-3xl text-center text-gray-600 font-bold mb-4 md:text-left">
            Your Profile
          </h1>
          <div className="flex flex-col md:flex-row ">
            <div className="md:w-1/4 mx-5 my-5 border-b-2 md:mx-20 md:mt-10 ">
              <div className="mb-4">
                <Image
              ...
              <h2 className=" text-xl mb-4 md:text-2xl">
                <span className="font-bold block text-gray-600">Name: </span>{" "}
                {profileName}
              </h2>
            ...
            <div className="md:w-3/4 md:pl-4">
              <h2 className="text-xl text-center text-gray-700 font-semibold mb-4 md:text-left">
                Your Listings
              </h2>
